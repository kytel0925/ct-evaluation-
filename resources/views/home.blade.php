            ...
            <v-tabs-items v-model="current_tab">
                        ...
                        <v-container fluid>
                            <v-row dense>
                                <v-col cols="3">
                                    <v-card>
                                        <v-list dense>
                                            <v-list-item-group v-model="current_question" color="primary">
                                                <v-list-item selectable v-for="(item, i) in phase_1_questions" :key="i"
                ...
                <v-tab-item key="phase-2">
                    <v-card>
                        ...
                        Phase 2
                        <div class="container">
                            <a href="{{route('person.index')}}">sale</a>
                        </div>
